# Original: https://github.com/FRC4564/HueBridge/tree/master
# Edited by dante_nl to accompany for scenes
...
class Bridge:
    ...
    def getScenes(self):
        """Returns dictionary of scene IDs and names."""
        dict = {}
        groups = self.allScenes()
        for s in scenes:
            dict[str(s)] = str(scenes[s]['name'])
        return dict
    
    def getScene(self,id):
        """Returns dictionary of scene details."""
        return self.get('scenes/{}'.format(str(id)))
